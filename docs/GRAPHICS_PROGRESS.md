...
| 06 SECONDARY LIFE     | Hair/cloth silhouette and secondary movement                                  | Planned; reconcile with exact next prompt          |
...
Only 05 has been worked on in this run. These are review targets, not premature implementation of later operations. At each milestone record its actual visual change, capture/inspect it in the executable scene, compare resource cost and document remaining defects.
