...
Operation 06 continuity: SECONDARY_LIFE_SPEC.md defines the implemented hair/cloth/facial approximations; SYSTEM_STATUS.md and evidence/secondary-life-validation.md identify actual acceptance and limits. Production target explicitly includes 16 GB VRAM on the requested modern 60+ CU-class RT-capable GPU. This capacity is not a measured device result or a promise of AAA completion.
