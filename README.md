...
An original open-world engineering prototype in the fictional port city of Navapur. OPERATION 02 — PHOTON extends the playable GENESIS foundation with a live WebGL2 rendering laboratory: differentiated physical materials, a filtered environment probe, planar puddle reflections, HDR/postprocessing where supported, and explicit quality controls. Real collision, player movement, streaming, crate persistence, and depot transitions remain part of the executable.

This is a procedural engineering prototype. The material laboratory's stationary car, auto-rickshaw, abstract character forms, and interior display demonstrate shading; they do not establish finished assets, vehicle dynamics, character animation, or new gameplay systems. See [system status](docs/SYSTEM_STATUS.md) for verified behavior, measurements, and limitations.
